...
function calcularEdad(fechaDeNacimiento: Date): number {
    ...
    const mesDeCumpleaños = fechaDeNacimiento.getMonth();
    //y el día de nacimiento fechaDeNacimiento.getDate 
    const diaDeCumpleaños = fechaDeNacimiento.getDate();
  ...
  console.log(`La edad es: ${cal} años`);